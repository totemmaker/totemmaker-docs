...
=== "Setup PlatformIO"
    ...
    1. Now select `PlatformIO: Serial Monitor` and you should start seeing text displayed from X4 board.  
...
=== "Setup Arduino IDE"
    ...
    **Step 9:** Open Serial Monitor.  
    :   Select `Tools` → `Serial Monitor`.  
        A window will open. It will display output from X4. Leave it open.  
        _Set **baud** to 115200._
    **Step 10:** Compile and upload code.  
