...
#### (`state`) module.color.isWhite() { data-toc-label='color.isWhite()' }
: Check if white line is detected.  
**Returns:**  
`state` -  white line detected [`true`:`false`]  

#### (`state`) module.color.isBlack() { data-toc-label='color.isBlack()' }
: Check if black line is detected.  
**Returns:**  
`state` -  black line detected [`true`:`false`]  

#### (`state`) module.color.isDetected() { data-toc-label='color.isDetected()' }
: Check if line color is detected.  
**Returns:**  
`state` -  line detected [`true`:`false`]  

#### (`state`) module.junction.isDetected() { data-toc-label='junction.isDetected()' }
...
#### (`contrast`) module.accuracy.get() { data-toc-label='accuracy.get()' }
...
#### module.accuracy.setThreshold(`contrast`) { data-toc-label='accuracy.setThreshold()' }
...
#### module.raw.get(`data[8]`) { data-toc-label='raw.get()' }
