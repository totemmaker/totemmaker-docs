...
#### (`color`) module.color.getHex() { data-toc-label='color.getHex()' }
...
#### (`color`) module.color.getR() { data-toc-label='color.getR()' }
#### (`color`) module.color.getG() { data-toc-label='color.getG()' }
#### (`color`) module.color.getB() { data-toc-label='color.getB()' }
: Get amount of specified RGB color (red, green, blue). Parsed from `getHex()` function.  
**Returns:**  
`color` - 8-bit amount of color [`0`:`255`]  

#### (`saturation`) module.colorR.get() { data-toc-label='colorR.get()' }
#### (`saturation`) module.colorG.get() { data-toc-label='colorG.get()' }
#### (`saturation`) module.colorB.get() { data-toc-label='colorB.get()' }
...
#### (`temperatureC`) module.temp.getC() { data-toc-label='temp.getC()' }
#### (`temperatureF`) module.temp.getF() { data-toc-label='temp.getF()' }
#### (`temperatureK`) module.temp.getK() { data-toc-label='temp.getK()' }
...
#### (`temperatureC`) module.ntc.getC() { data-toc-label='ntc.getC()' }
#### (`temperatureF`) module.ntc.getF() { data-toc-label='ntc.getF()' }
#### (`temperatureK`) module.ntc.getK() { data-toc-label='ntc.getK()' }
...
#### (`resistance`) module.ntc.getResistance() { data-toc-label='ntc.getResistance()' }
...
#### (`humidity`) module.humidity.get() { data-toc-label='humidity.get()' }
...
#### (`pressurePa`) module.pressure.getPa() { data-toc-label='pressure.getPa()' }
#### (`pressurehPa`) module.pressure.gethPa() { data-toc-label='pressure.gethPa()' }
#### (`pressureMbar`) module.pressure.getMbar() { data-toc-label='pressure.getMbar()' }
#### (`pressureBar`) module.pressure.getBar() { data-toc-label='pressure.getBar()' }
#### (`pressurePsi`) module.pressure.getPsi() { data-toc-label='pressure.getPsi()' }
...
#### (`altitudeM`) module.altitude.getMeter() { data-toc-label='altitude.getMeter()' }
#### (`altitudeFt`) module.altitude.getFoot() { data-toc-label='altitude.getFoot()' }
#### (`altitudeInch`) module.altitude.getInch() { data-toc-label='altitude.getInch()' }
...
#### module.setSeaLevel(`pressure`)  { data-toc-label='module.setSeaLevel()' }
