...
#### (`position`) module.knobA.get() { #knobA.get data-toc-label='knobA.get()' }
#### (`position`) module.knobB.get() { #knobB.get data-toc-label='knobB.get()' }
#### (`position`) module.knobC.get() { #knobC.get data-toc-label='knobC.get()' }
...
#### (`state`) module.buttonA.isPressed() { #buttonA.isPressed data-toc-label='buttonA.isPressed()' }
#### (`state`) module.buttonB.isPressed() { #buttonB.isPressed data-toc-label='buttonB.isPressed()' }
#### (`state`) module.buttonC.isPressed() { #buttonC.isPressed data-toc-label='buttonC.isPressed()' }
: Check if button is pressed.  
**Returns:**  
`status` - yes / no [`true`:`false`]  

#### (`state`) module.buttonA.isReleased() { #buttonA.isReleased data-toc-label='buttonA.isReleased()' }
#### (`state`) module.buttonB.isReleased() { #buttonB.isReleased data-toc-label='buttonB.isReleased()' }
#### (`state`) module.buttonC.isReleased() { #buttonC.isReleased data-toc-label='buttonC.isReleased()' }
...
#### module.led.setAlphaX(`number`, `alpha`) { #led.setAlphaX data-toc-label='led.setAlphaX()' }
